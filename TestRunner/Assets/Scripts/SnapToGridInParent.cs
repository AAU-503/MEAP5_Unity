...
public class SnapToGridInParent : MonoBehaviour {
    ...
    void Update() {
        ...
        x = (Mathf.Round(x_relative_to_parent + parent.transform.position.x * snapInverse) / snapInverse) - .5f;
        y = (Mathf.Round(y_relative_to_parent + parent.transform.position.y * snapInverse) / snapInverse) - .5f;
